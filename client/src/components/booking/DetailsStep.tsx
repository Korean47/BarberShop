...
export function DetailsStep({ value, errors, onChange, file, onFile, showReferenceUpload }: {
  ...
  return (
    <div>
      ...
      <p className="mt-4 flex items-start gap-2 text-xs leading-5 text-[var(--muted)]"><ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-[var(--primary)]" /> Podrás consultar la cita posteriormente con este teléfono y la fecha reservada.</p>
    </div>
  );
}
