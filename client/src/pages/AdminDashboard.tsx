      ...
      {loading ? (
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/5">
                  ...
                  <th className="text-left px-4 py-3 text-xs font-medium text-slate-500 uppercase tracking-wider">Barber</th>
        ...
        <div className="glass-card p-6">
          <h3 className="text-sm font-semibold text-white mb-4">
            Daily Schedule — {formatDateLong(new Date(filterDate + 'T00:00:00'))}
          </h3>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 pb-4 border-b border-slate-700">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Barber</p>
              </div>
